# weird-os &nbsp; [![bluebuild build badge](https://github.com/biennvops/weird-os/actions/workflows/build.yml/badge.svg)](https://github.com/biennvops/weird-os/actions/workflows/build.yml)
